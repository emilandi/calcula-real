var tasa;
var rate;
var taxpais=30; //impuesto PAIS
var taxafip=30; //adelanto ganancias
...
function getDatos () {
	...
	let url = 'https://dolarapi.com/v1/cotizaciones/brl';
	fetch(url)
...
function calcula () {
	...
	var afipARS = parseFloat(precioARS * taxafip / 100); //adelanto de ganancias 30
	var paisARS = parseFloat(precioARS * taxpais / 100); //impuesto PAIS 30		 	
	var total = parseFloat(precioARS + afipARS + paisARS);
